...
await sock.sendMessage(target, { 
    albumMessage: [
        { image: cihuy, caption: "#Ranstech" },
        { image: { url: "URL IMAGE" }, caption: "#Ranstech" }
    ] 
}, { quoted: m });
```
...
await sock.sendMessage(target, { 
    eventMessage: { 
        isCanceled: false, 
        name: "#Ranstech", 
        description: "#Ranstech", 
        location: { 
            degreesLatitude: 0, 
            degreesLongitude: 0, 
            name: "#Ranstech" 
        }, 
        joinLink: "https://call.whatsapp.com/video/RansK2New", 
...
await sock.sendMessage(target, {
    interactiveMessage: {
        header: "#Ranstech",
        title: "#Ranstech",
        footer: "telegram: @RansK2New ",
        buttons: [
            {
                name: "cta_copy",
                buttonParamsJson: JSON.stringify({
                    display_text: "#Ranstech",
                    id: "123456789",              
                    copy_code: "ABC123XYZ"
                })
            }
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                bottom_sheet: {            
                    ...
                    list_title: "#Ranstech",            
                    button_title: "#Ranstech"          
                },          
                tap_target_configuration: {            
                    title: " X ",            
                    description: "bomboclard",            
                    canonical_url: "https://t.me/RansK2New",            
...
await sock.sendMessage(target, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/RansK2New",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/RansK2New",
                    merchant_url: "https://t.me/RansK2New"
                })
            }
        ]
    }
...
- Has 1 newsletter follow, only the developer's WhatsApp channel: [WhatsApp Channel](https://whatsapp.com/channel/0029VbAJOR4DJ6H3p6aFhI1I)
...
- **Channel Tele**: [Channel Tele](https://t.me/ransforyou) 
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/rans-beep">
        <img src="https://github.com/rans-beep.png" width="80px;" style="border-radius:50%;" alt="Developer"/>
        <br />
        <sub><b>RansK2</b></sub>
      </a>
    </td>
